Coding Dojo
===========
The exercise itself is copied from https://github.com/matthewmorgan/gilded-rose-python-with-tests

The purpose of this repo is to make it work with modern python
